  ...
  return (
    <div className={`flex flex-col gap-2 ${className}`}>
      {cards.map((card) => {
        ...
        return (
          <Card key={card.key} className="border border-[color:var(--border)] bg-[color:var(--card)] px-9 py-7.5 space-y-1 transition-all duration-200 hover:border-[#b90abd]/40 hover:bg-[color:var(--background)]">
            ...
            <div className="rounded border border-[color:var(--border)] bg-[rgba(26,26,26,0.55)] py-1 text-center">
