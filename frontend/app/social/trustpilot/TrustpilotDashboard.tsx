...
export function TrustpilotDashboard({
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <Card className={`relative overflow-hidden group transition-all duration-300 shadow-lg hover:shadow-2xl ${
              ...
              <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none ${
                avgRating < 4.0 ? 'bg-gradient-to-br from-[#b90abd]/10 via-[#b90abd]/5 to-transparent' : ''
              }`} />
            ...
            <Card className={`relative overflow-hidden group transition-all duration-300 shadow-lg hover:shadow-2xl ${
              ...
              <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none ${
                repliedPercent < 70 ? 'bg-gradient-to-br from-[#b90abd]/10 via-[#b90abd]/5 to-transparent' : ''
              }`} />
            ...
            <Card className={`relative overflow-hidden group transition-all duration-300 shadow-lg hover:shadow-2xl ${
              ...
              <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none ${
                avgResponseTimeHours > 4 ? 'bg-gradient-to-br from-[#b90abd]/10 via-[#b90abd]/5 to-transparent' : ''
              }`} />
            ...
            <Card className={`relative overflow-hidden group transition-all duration-300 shadow-lg hover:shadow-2xl ${
              ...
              <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none ${
                positiveReviewsPercent < 70 ? 'bg-gradient-to-br from-[#b90abd]/10 via-[#b90abd]/5 to-transparent' : ''
              }`} />
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,_1.6fr)_minmax(0,_1fr)] gap-6 items-start">
          ...
          <Card className="bg-gray-900 border-gray-700 xl:h-full">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-white">
